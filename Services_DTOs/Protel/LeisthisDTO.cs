...
namespace Hit.Services.DTOs.Protel
{
    ...
    public class LeisthisDTO
    {
        ...
        public int buchref { get; set; } //(int, not null)
        ...
        public string gast { get; set; } //(varchar(50), not null)
        ...
        public int user3 { get; set; } //(int, not null)
        public string eftreceipt { get; set; } //(varchar(12), not null)
        public string eftauthcd { get; set; } //(varchar(30), not null)
        public decimal kurs { get; set; } //(decimal(19,6), not null)
        public string zatext { get; set; } //(varchar(30), not null)
        ...
        public string uktobez { get; set; } //(varchar(40), not null)
        public string uktonr { get; set; } //(varchar(10), not null)
