...
{
    public class LeisthisModel
    {

       // datum,uhrzeit, mpehotel, rechnr, fisccode, Ref, kundennr, epreis,anzahl,zimmer,rechnung,mwstsatz,vatno,tax1,rkz,ukto,voidref,voidreason,deposit,deposituse
